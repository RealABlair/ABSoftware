...
namespace ABSoftware.Networking.Packets
{
    public class PacketBuffer : ByteBuilder
    {
        ...
        public void Write<T>(T value)
        {
            ...
            if (type == typeof(uint)) this.Append(new byte[4] { (byte)((int)(object)value & 0xFF), (byte)((int)(object)value >> 8 & 0xFF), (byte)((int)(object)value >> 16 & 0xFF), (byte)((int)(object)value >> 24 & 0xFF) });
